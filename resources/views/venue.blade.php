        ...
        <div class="bg-white">
          ...
          <div class="row mt-5">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
              <a href="{{ $galleryItem->getUrl() }}" class="image-popup gal-item"><img src="{{ $galleryItem->getUrl() }}" alt="{{$venue->name}} {{$loop->iteration}}" class="img-fluid"></a>
            </div>
            @endforeach
          </div>
          ...
          <div class="row mt-5">
            <div class="col-12">
              <div style="width: 100%; height:400px" id="address-map">
