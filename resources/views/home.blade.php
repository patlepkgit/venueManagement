...
<div class="slide-one-item home-slider owl-carousel">
  ...
  <div class="site-blocks-cover" style="background-image: url('{{$featuredVenue['hero_image']}}');" data-aos="fade" data-stellar-background-ratio="0.5">
    ...
    <div class="text">
      ...
      <p class="mb-0"><a href="{{$featuredVenue['link']}}" class="text-uppercase small letter-spacing-1 font-weight-bold">More Details</a></p>
...
<div class="py-5">
  <div class="container">
    <form class="row mb-5" action="{{route('search')}}" method="GET">
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
        <div class="select-wrap">
          <input type="number" name="people_amount" id="people_amount" class="form-control d-block rounded-0" min="1" placeholder="People Amount">
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
        <div class="select-wrap">
